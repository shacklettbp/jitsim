...
llvm::Value * FunctionEnvironment::lookupValue(const JITSim::Value *lookup) const
{
  return named_values.find(lookup)->second;
}

void FunctionEnvironment::addValue(const JITSim::Value *key, llvm::Value *val)
{
